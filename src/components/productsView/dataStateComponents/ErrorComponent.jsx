function ErrorComponent({ refetchFunction, small }) {
  return (
    <div
      className="flex gap-4 justify-center flex-col items-center mb-3"
      style={{ marginTop: small ? "0rem" : "2.75rem" }}
    >
      <p
      ...
      <button
        className="p-2 rounded-full border-2 border-buttons-unhoveredProductButtons hover:border-[#231F20] group"
        onClick={() => {
          refetchFunction();
        }}
      >
        {/* one time svg fuck it no need to create an asset */}
        <svg
          height={small ? 15 : 30}
          width={small ? 15 : 30}
        ...
        >
          <path
            className="group-hover:fill-[#231F20] fill-buttons-unhoveredProductButtons"
            fill="#231F20"
