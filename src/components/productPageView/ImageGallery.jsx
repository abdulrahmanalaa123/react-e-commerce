...
function ImageGallery({ images }) {
  ...
  return (
    <section
      id="image-gallery"
      className="flex-auto mb-8 md:mb-0 md:w-1/2 z-0 flex-col flex h-[600px] "
    >
      <PhotosCarousel
      ...
      <PhotosCarousel
        ...
        currentSlideIdx={currentPhotoIdx}
        className="relative rounded-sm h-min max-h-20 mt-6 max-w-full mx-auto   "
      ...
      >
        {images.map((image, index) => {
          return (
            <div
              className={`w-full h-full mx-3 min-w-min px-0 ${
